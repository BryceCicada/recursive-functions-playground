    ...
    describe('visit()', function () {
        ...
        describe('ConstASTNode', function () {
            ...
            it('should evaluate 0', function () {
                ...
                expect(evaluation).to.be.a('ConstASTNode');
        ...
        describe('CompositionASTNode', function () {
            ...
            it('should evaluate S.(S) to S.(S)', function () {
                ...
                expect(evaluation).to.be.a('CompositionASTNode');
                expect(evaluation.func).to.be.a('SuccessorASTNode');
                expect(evaluation.args[0]).to.be.a('SuccessorASTNode');
            });
            ...
            it('should evaluate P^2_0.(S,S) to S', function () {
                ...
                expect(evaluation).to.be.a('SuccessorASTNode');
            });
        });
    });
});
